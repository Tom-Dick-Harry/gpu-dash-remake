// filepath: c:\Users\suvan\projects\sys-dashboard\src\server.rs
...
// Main server function that can be called from other modules
pub fn run_server() {
...
// Standalone mode for when running the server on its own
pub fn main() {
    run_server();
}